...
enum parameters {TAU, KAPPA, DELTA, LAMBDA, PSIX, PSIY, ETA};
...
class mesh{
    ...
    public:
        void setParameters(float tau, float kappa, float delta, float lambda, float psi_x, float psi_y, float eta){
            parameters[TAU]=tau;
            parameters[KAPPA]=kappa;
            parameters[DELTA]=delta;
            parameters[LAMBDA]=lambda;
            parameters[PSIX]=psi_x;
            parameters[PSIY]=psi_y;
            parameters[ETA]=eta;
        }
